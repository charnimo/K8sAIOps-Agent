...
MONITORING_TOOL_REGISTRY: Dict[str, Tool] = {
    ...
    "update_deployment_image": Tool(
        name="update_deployment_image",
        func=lambda namespace, deployment_name, image, container_name=None: deployments.update_deployment_image(
            name=deployment_name,
            namespace=namespace,
            container_name=container_name,
            image=image,
        ),
        description="Update a Deployment container image. ACTION",
        category="action",
        parameters={
            "namespace": {"type": "string", "description": "Kubernetes namespace"},
            "deployment_name": {"type": "string", "description": "Deployment name"},
            "container_name": {"type": "string", "description": "Container name (optional if single container)"},
            "image": {"type": "string", "description": "Full image reference, e.g. nginx:1.25"},
        },
        permission_required="deployments:patch",
        is_read_only=False,
    ),
    "patch_deployment_command": Tool(
        name="patch_deployment_command",
        func=lambda namespace, deployment_name, container_name=None, command=None, args=None: deployments.patch_deployment_command(
            name=deployment_name,
            namespace=namespace,
            container_name=container_name,
            command=command,
        ...
        description="Patch a Deployment container command or args. ACTION",
        category="action",
        parameters={
            "namespace": {"type": "string", "description": "Kubernetes namespace"},
            "deployment_name": {"type": "string", "description": "Deployment name"},
            "container_name": {"type": "string", "description": "Container name (optional if single container)"},
            "command": {"type": "array", "description": "New command list, e.g. ['sleep', '3600']"},
            "args": {"type": "array", "description": "Optional new args list"},
        },
        permission_required="deployments:patch",
        is_read_only=False,
    ),
    "patch_deployment_node_selector": Tool(
        name="patch_deployment_node_selector",
        func=lambda namespace, deployment_name, node_selector=None, remove_keys=None, replace=False: deployments.patch_deployment_node_selector(
            name=deployment_name,
            namespace=namespace,
        ...
        description="Patch, replace, or remove Deployment pod-template nodeSelector entries. ACTION",
        category="action",
        parameters={
            "namespace": {"type": "string", "description": "Kubernetes namespace"},
            "deployment_name": {"type": "string", "description": "Deployment name"},
            "node_selector": {"type": "object", "description": "Selector labels to set or merge"},
            "remove_keys": {"type": "array", "description": "Node selector keys to remove"},
            "replace": {"type": "boolean", "description": "Replace the full selector instead of merging"},
        },
        permission_required="deployments:patch",
        is_read_only=False,
    ),
    ...
    "patch_cronjob_starting_deadline": Tool(
        name="patch_cronjob_starting_deadline",
        func=jobs.patch_cronjob_starting_deadline,
        description="Set or clear CronJob startingDeadlineSeconds. ACTION",
        category="action",
        parameters={
            "name": {"type": "string"},
            "namespace": {"type": "string", "default": 'default'},
            "starting_deadline_seconds": {"type": "number", "default": None},
        },
        permission_required="modify",
        is_read_only=False,
    ),

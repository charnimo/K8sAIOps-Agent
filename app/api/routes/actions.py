...
ACTION_PERMISSION_MAP = {
    ...
    "update_deployment_image": "deployments:patch",
    "patch_deployment_command": "deployments:patch",
    "patch_deployment_node_selector": "deployments:patch",
    ...
    "patch_cronjob_starting_deadline": "workloads:cronjobs:patch",

...
EXPECTED_DIRECT_ROUTE_METHODS = {
    ...
    "/resources/deployments/{name}/image": {"patch"},
    "/resources/deployments/{name}/command": {"patch"},
    "/resources/deployments/{name}/node-selector": {"patch"},
    ...
    "/workloads/cronjobs/{name}/starting-deadline": {"patch"},
